 ...
 */
/*
 * Translators: Ivan Samokhin jrr at mail ru
 *
 *
 * Rev:
 */
 ...
 * or emacs on Linux with ISO-8859-5 encoding 
 *
 ********************************************************************/
...
.keypad					= "Кнопка", // MaxLen: 12 (with .ptt)
.ptt					= "Тангента", // MaxLen: 12 (with .keypad)
.locked					= "Заблокировано", // MaxLen: 15
.press_blue_plus_star			= "Нажми Blue + *", // MaxLen: 19
.to_unlock				= "to unlock", // MaxLen: 19
.unlocked				= "Разблокирован", // MaxLen: 15
...
.tg_entry				= "TG ввод", // MaxLen: 15
.pc_entry				= "PC ввод", // MaxLen: 15
.user_dmr_id				= "Польз. DMR ID", // MaxLen: 15
.contact 				= "Контакт", // MaxLen: 15
.accept_call				= "Ответить", // MaxLen: 16
...
.vfoToNewChannel			= "VFO --> Новый канал", // MaxLen: 16
...
.n_a					= "Н/Д",// MaxLen: 16 (with ':' * .colour_code)
.bandwidth				= "Шир. полосы", // MaxLen: 16 (with ':' + .n_a, "25kHz" or "12.5kHz")
...
.all_skip				= "Проп. всех ", // MaxLen: 16 (with ':' + .yes or .no)
...
.band_limits				= "Лимиты диап.", // MaxLen: 16 (with ':' + .on or .off)
...
.dmr_filter_timeout			= "Зд. фильтра", // MaxLen: 16 (with ':' + 1..90 + 's')
...
.scan_delay				= "Зд. сканера", // MaxLen: 16 (with ':' + 1..30 + 's')
...
.all_call				= "Общий вызов", // MaxLen: 16
.tone_scan				= "Tone scan", // MaxLen: 16
.low_battery				= "БАТАРЕЯ РАЗРЯЖЕНА!", // MaxLen: 16
.Auto					= "Авто", // MaxLen 16 (with .mode + ':') 
.manual					= "Вручную",  // MaxLen 16 (with .mode + ':')
.ptt_toggle				= "PTT захват", // MaxLen 16 (with ':' + .on or .off)
...
.audio_prompt				= "Подсказки",// Maxlen 16 (with ':' + .silent, .normal, .beep or .voice_prompt_level_1)
.silent                                 = "Silent", // Maxlen 16 (with : + audio_prompt)
.normal                                 = "Норм.", // Maxlen 16 (with : + audio_prompt)
.beep					= "Тон", // Maxlen 16 (with : + audio_prompt)
.voice_prompt_level_1			= "Голос 1", // Maxlen 16 (with : + audio_prompt)
...
.voice_prompt_level_2			= "Голос 2", // Maxlen 16 (with : + audio_prompt)
.voice_prompt_level_3			= "Голос 3", // Maxlen 16 (with : + audio_prompt)
.dmr_filter				= "DMR фильтр",// MaxLen: 12 (with ':' + settings: "TG" or "Ct" or "RxG")
.dmr_cc_filter				= "CC фильтр", // MaxLen: 12 (with ':' + settings: .on or .off)
.dmr_ts_filter				= "TS фильтр", // MaxLen: 12 (with ':' + settings: .on or .off)
